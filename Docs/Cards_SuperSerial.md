...
- Shares the same connection types as the IIgs built-in serial ports: **None**, **File**, or **Modem**.
...
3. Under **Serial / Parallel**, click the port button for that slot and pick **Modem** or **File** (see [Serial & Parallel Connections](SerialConnections.md)).
4. Save and launch.

...
call("tools/call", {"name": "mem_diff", "arguments": {"action": "snapshot", "addr": 0x300, "len": 16}})
call("tools/call", {"name": "poke", "arguments": {"addr": 0x305, "bytes": [0xAB]}})
call("tools/call", {"name": "mem_diff", "arguments": {"action": "diff"}})
call("tools/call", {"name": "screen_text", "arguments": {}})

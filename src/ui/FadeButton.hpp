...
public:
    FadeButton_t(UIContext *ctx, const std::string& button_text, const Style_t& style = Style_t(), int group = 0) : Button_t(ctx, button_text, style, group) {}
    FadeButton_t(UIContext *ctx, int assetID, const Style_t& style = Style_t(), int group = 0) : Button_t(ctx, assetID, style, group) {}
    FadeButton_t(UIContext *ctx, const std::string& button_text, int group = 0) : Button_t(ctx, button_text, group) {}

...
/**
 * VGA mode 0x01 — 40x25 text. CRTC horizontals from IBM VGA mode 01h;
 * verticals / OTI ext match SS mode 03h text path (same 9x16 cells, base at 0x010000).
 */
inline constexpr ss_vga_mode_rec SS_ROM_VGA_TEXT_40X25 = {
    0x67, // misc
    0x00, // sequencer clocking mode
    0x00, // feature / PEL mask
    0x03, // seq02 map mask
    ...
    0x02, // seq04 memory mode
    { // crt
        0x2D, 0x27, 0x28, 0x90, 0x2B, 0xA0, // 00-05 (40-col horizontals)
        0xBF, 0x1F, 0x00, 0x4F, 0x2D, 0x0E, // 06-0B
        0x00, 0x00, 0x00, 0x00,             // 0C-0F
        0x9C, 0x8E, 0x8F, 0x14, 0x1F,       // 10-14 (offset 0x14 → pitch 80)
        0x96, 0xB9, 0xA3, 0xFF,             // 15-18
    },
    { // graphics
        0x00, 0x00, 0x00, 0x00, 0x00,

...
/*
 * W5100 / Uthernet II register definitions.
 * Adapted from AppleWin W5100.h (Andrea Odetti / AppleWin, GPL).
 */

#include <cstdint>

// Only A0 and A1 are decoded on the slot C0nX ports.

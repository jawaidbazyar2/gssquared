...
static const RGBA_t gs_rgb_colors_wrong[16] = {
    {.r=0x00, .g=0x00, .b=0x00, .a=0xFF}, // 0x0000 - Black        0b0000 - ok
    {.r=0xDD, .g=0x00, .b=0x33, .a=0xFF}, // 0x0D03 - Deep Red     0b0001 - ok
    {.r=0x00, .g=0x00, .b=0x99, .a=0xFF}, // 0x0009 - Dark Blue    0b0010 - brown
    {.r=0xDD, .g=0x22, .b=0xDD, .a=0xFF}, // 0x0D2D - Purple       0b0011 - orange
    {.r=0x00, .g=0x77, .b=0x22, .a=0xFF}, // 0x0072 - Dark Green   0b0100 - ok
    {.r=0x55, .g=0x55, .b=0x55, .a=0xFF}, // 0x0555 - Dark Gray    0b0101 - ok
    {.r=0x22, .g=0x22, .b=0xFF, .a=0xFF}, // 0x022F - Medium Blue  0b0110 - light green
    {.r=0x66, .g=0xAA, .b=0xFF, .a=0xFF}, // 0x06AF - Light Blue   0b0111 - yellow
    {.r=0x88, .g=0x55, .b=0x00, .a=0xFF}, // 0x0850 - Brown        0b1000 - dk blue
    {.r=0xFF, .g=0x66, .b=0x00, .a=0xFF}, // 0x0F60 - Orange       0b1001 - purple
    {.r=0xAA, .g=0xAA, .b=0xAA, .a=0xFF}, // 0x0AAA - Light Gray  0b1010 - ok
    {.r=0xFF, .g=0x99, .b=0x88, .a=0xFF}, // 0x0F98 - Pink        0b1011 - ok
    {.r=0x11, .g=0xDD, .b=0x00, .a=0xFF}, // 0x01D0 - Light Green 0b1100 - med blu
    {.r=0xFF, .g=0xFF, .b=0x00, .a=0xFF}, // 0x0FF0 - Yellow      0b1101 - lt blue
    {.r=0x44, .g=0xFF, .b=0x99, .a=0xFF}, // 0x04F9 - Aquamarine  0b1110 - ok
    {.r=0xFF, .g=0xFF, .b=0xFF, .a=0xFF}  // 0x0FFF - White       0b1111 - ok
};

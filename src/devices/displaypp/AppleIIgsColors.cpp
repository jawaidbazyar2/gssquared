...
namespace AppleIIgs {
    ...
    const RGBA_t TEXT_COLORS[16] = {
        RGBA_t::make(0x00, 0x00, 0x00, 0xFF), // 0x0000 - Black    
        RGBA_t::make(0xDD, 0x00, 0x33, 0xFF), // 0x0D03 - Deep Red
        RGBA_t::make(0x00, 0x00, 0x99, 0xFF), // 0x0009 - Dark Blue
        RGBA_t::make(0xDD, 0x22, 0xDD, 0xFF), // 0x0D2D - Purple     
        RGBA_t::make(0x00, 0x77, 0x22, 0xFF), // 0x0072 - Dark Green 
        RGBA_t::make(0x55, 0x55, 0x55, 0xFF), // 0x0555 - Dark Gray  
        RGBA_t::make(0x22, 0x22, 0xFF, 0xFF), // 0x022F - Medium Blue
        RGBA_t::make(0x66, 0xAA, 0xFF, 0xFF), // 0x06AF - Light Blue 
        RGBA_t::make(0x88, 0x55, 0x00, 0xFF), // 0x0850 - Brown      
        RGBA_t::make(0xFF, 0x66, 0x00, 0xFF), // 0x0F60 - Orange     
        RGBA_t::make(0xAA, 0xAA, 0xAA, 0xFF), // 0x0AAA - Light Gray
        RGBA_t::make(0xFF, 0x99, 0x88, 0xFF), // 0x0F98 - Pink      
        RGBA_t::make(0x11, 0xDD, 0x00, 0xFF), // 0x01D0 - Light Green
        RGBA_t::make(0xFF, 0xFF, 0x00, 0xFF), // 0x0FF0 - Yellow     
        RGBA_t::make(0x44, 0xFF, 0x99, 0xFF), // 0x04F9 - Aquamarine 
        RGBA_t::make(0xFF, 0xFF, 0xFF, 0xFF)  // 0x0FFF - White      
    };
}
